        ...
        title: Padding(
          ...
          child: Row(
            ...
            children: [
              Row(
                children: [
                  SvgPicture.asset("assets/dog4.svg", height: 25, width: 25,),
                  Padding(
                ...
                child: Row(
                  children: [
                    ElevatedButton(
                      ...
                      child: Text("Carousel", style: TextStyle(fontSize: 13),),
                    ),
                    Container(
                      width: 160,
                      child: Row(
                        children: [
                          ...
                          if (_showPackageInfo)
                            Column(
                              ...
                              children: [
                                Text("App: $_packageAppName",
                                    style: TextStyle(fontSize: 11)),
                                Text("Package: $_packageName",
                                    style: TextStyle(fontSize: 11)),
                                Text("Version: $_packageVersion",
                                    style: TextStyle(fontSize: 11)),
                              ],
                            ),
                        ],
